...
/// /home/pratn/Documents/interstellar/integritee-worker/cli/src/trusted_operation.rs
...
pub(crate) fn perform_trusted_operation(
	...
	match top {
		TrustedOperation::indirect_call(_) => {
			todo!("Not implemented: perform_trusted_operation::indirect_call")
			// send_request(cli, trusted_args, top)
	},
